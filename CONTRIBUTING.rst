...
Everyone interacting in the PyPkg Bintray 01 project's code base,
...
Report bugs at https://github.com/goerz-testing/pypkg_bintray_01/issues.
...
The best way to send feedback is to file an issue at https://github.com/goerz-testing/pypkg_bintray_01/issues.
...
3. Check https://travis-ci.org/goerz-testing/pypkg_bintray_01/pull_requests
...
Ready to contribute? Follow `Aaron Meurer's Git Workflow Notes`_ (with ``goerz-testing/pypkg_bintray_01`` instead of ``sympy/sympy``)

In short,

1. Clone the repository from ``git@github.com:goerz-testing/pypkg_bintray_01.git``
...
PyPkg Bintray 01 uses a simple branching model where all
...
PyPkg Bintray 01 includes a full test-suite using pytest_.
We strive for a `test coverage`_ above 90%.


From a checkout of the ``pypkg_bintray_01`` repository  you can use
...
.. _test coverage: https://codecov.io/gh/goerz-testing/pypkg_bintray_01
...
PyPkg Bintray 01 could always use more documentation, whether
...
At any point, from a checkout of the ``pypkg_bintray_01``
...
:mod:`pypkg_bintray_01` package:

.. doctest::

    >>> import pypkg_bintray_01
    >>> pypkg_bintray_01.__version__   # doctest: +SKIP
...
https://github.com/goerz-testing/pypkg_bintray_01/releases.
